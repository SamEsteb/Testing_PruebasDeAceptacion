Feature: Registro de un nuevo ususario den el sistema
    ...
    Scenario: Registro exitoso de un nuevo Estudiante
        ...
        When ingreso un nombre válido "Juan"
        And ingreso un apellido válido "Pérez Cabalga"
        And ingreso mi numero de matricula "2023-AB-001"
        And ingreso un correo electrónico unico "juan.caba@uest.com"
        ...
        And un nuevo registro de 'Estudiante' debe existir en la base de datos con el correo "juan.caba@uest.com"
